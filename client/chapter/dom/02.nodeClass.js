...
// - nodeName (vs. tagName)
console.log(first.nodeType === 'SPAN');
console.log(first.nodeType !== 'SPAN');
...
// * 기존 내용 삭제
first.innerHTML = '';  // 통으로 비우고 싶을때

// * 기존 내용과 새로운 내용을 합친 새로운 내용을 씀
first.innerHTML += '<strong>like lion</strong>'; //태그도 추가 가능
...
// * 요소 내의 텍스트에 접근
first.textContent += 'like lion'; // set
