...
for(let key in authUser){
  if(Object.prototype.hasOwnProperty.call(authUser,key)){ //object.prototype을 {}로 대체할 수 있음
    console.log(key);
  }
}
...
// 프로퍼티 나열   authUser : 객체     key 만 몬아놓은 배열, value 만 모아놓은 배열 만들어주세요
...
//shorthand property
const student = { name, email, authrization, isLogin, }
